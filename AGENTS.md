...
- ALWAYS open files in VS Code after creating or modifying them using `open` command (e.g. `open ~/Desktop/Pi\ comms/ticket-{number}-reply.md`) so Brendan can see changes immediately
